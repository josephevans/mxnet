...
def main():
    ...
    parser.add_option("-a", "--ami", dest="ami", default="ami-0d1cd67c26f5fca19",
        help="initial AMI to use (defaults to ubuntu 18.04 lts in us-west-2)")
    parser.add_option("-n", "--name", dest="name", default="ami-builder",
        help="Prefix to use for AMI name (timestamp will be appended)")
    parser.add_option("-d", "--disk-size", dest="disk_size", type="int",
        default=10, help="Size of disk to use for image creation")
    ...
    # TODO check options and make sure userdata file exists
